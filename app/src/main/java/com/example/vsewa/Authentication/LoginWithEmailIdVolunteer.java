...
public class LoginWithEmailIdVolunteer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent forgotPasswordIntent = new Intent(LoginWithEmailIdVolunteer.this, ForgotPassword.class);
...
//                    passwd.setErrorEnabled(true);
                    ...
                    mAuth.signInWithEmailAndPassword(email_t, password_t)
                            .addOnCompleteListener(LoginWithEmailIdVolunteer.this, new OnCompleteListener<AuthResult>() {
                                @Override
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        databaseReference.child("Users").child("Volunteer").child(current_user).child("device_token").setValue(device_token).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                dialog.dismiss();
                                                Intent i=new Intent(LoginWithEmailIdVolunteer.this, BottomNavigatioActivity.class);
                                                startActivity(i);
                                                finish();
...
//                                emailId.setErrorEnabled(true);
                                ...
                                dialog.dismiss();
                                Toast.makeText(LoginWithEmailIdVolunteer.this, "Authentication failed",
                    ...
                    dialog.dismiss();
                    Toast.makeText(LoginWithEmailIdVolunteer.this, "Unknown error",
                            Toast.LENGTH_SHORT).show();
                }
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(LoginWithEmailIdVolunteer.this, RegisterWithEmailActivity.class);
                startActivity(i);
